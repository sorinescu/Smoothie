...
void PlatformConfig::config_get_command( string parameter ){
...
void PlatformConfig::config_set_command( string parameters ){
...
void PlatformConfig::config_load_command( string parameters ){
...
// See get_checksum
void PlatformConfig::set_string( string setting, string value ){
...
bool PlatformConfig::has_config_file(){
...
string PlatformConfig::get_config_file(){
...
inline void PlatformConfig::try_config_file(string candidate){
