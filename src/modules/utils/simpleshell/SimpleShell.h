...
class SimpleShell : public Module {
    public:
        ...
        void pwd_command(  smt_string parameters, StreamOutput* stream );
        void cat_command(  smt_string parameters, StreamOutput* stream );
        void play_command( smt_string parameters, StreamOutput* stream );
        void reset_command(smt_string parameters, StreamOutput* stream );

        smt_string current_path;
        bool playing_file;
